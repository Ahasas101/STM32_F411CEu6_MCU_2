/*
 * In this code we are using the output compare mode of the general purpose timers to generate the square waveforms
 * of different frequencies over 4 channels, he we compared the value of the timer ( counter) to the value in the reg
 * on the basis of that the frequencies were decided
 */
